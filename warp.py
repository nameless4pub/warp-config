...
def warp_ip():
    ...
    with open(result_path, 'r') as csv_file:
        ...
        config_prefix1 = f'warp://{ip1}?ifp=10-20&ifps=40-100&ifpd=10-20#🇮🇷 Warp&&detour=warp://{ip1}?ifp=10-20&ifps=40-100&ifpd=10-20#🇩🇪 Warp'
        config_prefix2 = f'warp://{ip2}?ifp=10-20&ifps=40-100&ifpd=10-20#🇮🇷 Warp&&detour=warp://{ip2}?ifp=10-20&ifps=40-100&ifpd=10-20#🇩🇪 Warp'
        config_prefixes += config_prefix1 + '\n' + config_prefix2
    return config_prefixes, formatted_time

title = "//profile-title: base64:" + base64.b64encode('WARP➡SUB{4Pub}'.encode('utf-8')).decode('utf-8') + "\n"
...
configs = warp_ip()[0]
with open('export/warp.json', 'w') as op:
